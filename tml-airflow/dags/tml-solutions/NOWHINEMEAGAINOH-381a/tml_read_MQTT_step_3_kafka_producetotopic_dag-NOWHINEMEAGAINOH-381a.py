...
default_args = {
  ...
  'mqtt_broker' : '1b9f19211f844f04ba047bd98e206348.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_NOWHINEMEAGAINOH-381a", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_NOWHINEMEAGAINOH-381a"], schedule=None,catchup=False)
