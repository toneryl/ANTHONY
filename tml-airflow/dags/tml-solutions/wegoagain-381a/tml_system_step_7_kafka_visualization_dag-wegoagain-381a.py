...
@dag(dag_id="tml_system_step_7_kafka_visualization_dag_wegoagain-381a", default_args=default_args, tags=["tml_system_step_7_kafka_visualization_dag_wegoagain-381a"], schedule=None,catchup=False)
def startstreaming():    
  def empty():
      pass
dag = startstreaming()
