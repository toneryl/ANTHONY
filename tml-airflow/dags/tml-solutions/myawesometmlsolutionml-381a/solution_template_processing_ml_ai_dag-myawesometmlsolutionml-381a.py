...
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-381a.tml_read_LOCALFILE_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-381a")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_dag-myawesometmlsolutionml-381a",
